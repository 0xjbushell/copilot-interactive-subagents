...
export const RESUME_TARGETED_MUTANTS = [
  ...
  {
    id: "resume-invalid-session-check",
    file: ".github/extensions/copilot-interactive-subagents/lib/resume.mjs",
    from: '    code: probe.code ?? "RESUME_TARGET_INVALID",',
    to: '    code: probe.code ?? "RESUME_ATTACH_FAILED",',
  },
  {
    id: "resume-attach-failure-code",
    file: ".github/extensions/copilot-interactive-subagents/lib/resume.mjs",
    from: '      code: "RESUME_ATTACH_FAILED",',
    to: '      code: "RESUME_TARGET_INVALID",',
  },
  {
    id: "resume-running-ok",
    file: ".github/extensions/copilot-interactive-subagents/lib/resume.mjs",
    from: '    ok: manifest.status === "running" || manifest.status === "success",',
